...
#include <QToolButton>
#include <QDialog>
#include "kfocusswitchhelper.h"

/*
	KDialog
*/
class /*KFRAME_API*/ KDialog : public QDialog
{
    Q_OBJECT
	friend class KFocusSwitchHelper<KDialog>;
public:
	explicit KDialog(QWidget *parent = nullptr, int nShadowWidth = 0, int nBorderWidth = 2);
	~KDialog();
	...
	/* 输入组件焦点切换辅助类 */
	KFocusSwitchHelper<KDialog>* iFSHelper();
...
private:
	...
	// 输入组件焦点切换辅助类
	KFocusSwitchHelper<KDialog>* m_pFocusSwitchHelper = nullptr;
};
