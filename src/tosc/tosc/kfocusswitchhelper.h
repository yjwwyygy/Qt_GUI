#ifndef KFOCUSSWITCHHELPER_H
#define KFOCUSSWITCHHELPER_H
...
template <typename T>
class KFocusSwitchHelper : QObject
{
public:
    /* 创建事件过滤器 */
    KFocusSwitchHelper(T* pWindow): m_pWindow(pWindow)
    {
...
protected:
    ...
    bool eventFilter(QObject* obj, QEvent * evt)
    {
										...
										keyPress->key() == Qt::Key_Right)))
        {
            ...
            // 下拉组合框用左右方向键代替上下方向键
			if (widget->inherits("QComboBox") && !widget->inherits("KCheckComboBox"))
            {
