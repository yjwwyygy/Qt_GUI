...
KDialog::KDialog(QWidget *parent, int nShadowWidth, int nBorderWidth)
	: QDialog(parent)
{
	...
	m_pFocusSwitchHelper = new KFocusSwitchHelper<KDialog>(this);
}
...
/* 系统样式改变信号处理槽 */
void KDialog::doSystemStyleChanged()
{
...
int KDialog::titleTextRightPos() const
{
	return m_nTitleTextRightPos;
}

int KDialog::titleTextMaxRightPos() const
{
	return m_nTitleTextMaxRightPos;
}

int KDialog::calcTitleBarLeftBeginPosition() const
{
...
void KDialog::layoutTitleBarWidgets()
{
	// 靠左布局起始位置
...
void KDialog::doActionCloseTriggered()
{
	close();
}

void KDialog::doActionMaxTriggered()
{
	if (isMaximized())
	{
		showNormal();
...
void KDialog::doActionMinTriggered()
{
	showMinimized();
}
...
void KDialog::mouseMoveEvent(QMouseEvent * evt)
{
...
void KDialog::mousePressEvent(QMouseEvent * evt)
{
...
void KDialog::mouseReleaseEvent(QMouseEvent * evt)
{
	if (evt->button() == Qt::LeftButton)
	{
		m_bMousePressedOnTitle = false;
...
void KDialog::mouseDoubleClickEvent(QMouseEvent * evt)
{
...
void KDialog::paintEvent(QPaintEvent * evt)
{
	Q_UNUSED(evt);
...
void KDialog::showEvent(QShowEvent *evt)
{
	ensurePolished();
	adjustPosition();
...
void KDialog::setMouseResizeCursor(const QPoint& pt)
{
...
void KDialog::changeSize(QMouseEvent* evt)
{
...
/* 计算改变的最小宽和高 */
QSize KDialog::calcMinSize(const QSize &sizeHint, const QSize &minSizeHint,
...
void KDialog::drawWindowBorder(QPainter& painter)
{
...
void KDialog::drawSystemTitleBar(QPainter& painter)
{
	if (isActiveWindow())
	{
...
void KDialog::drawSystemTitleText(QPainter& painter, const QString& sTitle)
{
	int nLeft = m_nActualBorderWidth + CWinTitleTextIndent;
	if (!windowIcon().isNull()) nLeft += m_oWinIconSize.width() + CWinTitleTextIndent;
...
bool KDialog::forbidEscapeKeyClose() const
{
	return m_bForbidEscapeKeyClose;
}

void KDialog::setForbidEscapeKeyClose(bool value)
{
	m_bForbidEscapeKeyClose = value;
}

bool KDialog::allowResize() const
{
	return m_bAllowResize;
}

void KDialog::setAllowResize(bool value)
{
...
bool KDialog::forbidTopBorderOutScreen() const
{
	return m_bForbidTopBorderOutScreen;
}

void KDialog::setForbidTopBorderOutScreen(bool value)
{
	m_bForbidTopBorderOutScreen = value;
}

bool KDialog::showMinimumButton() const
{
	return m_bShowMinButton;
}

void KDialog::setShowMinimumButton(bool value)
{
...
bool KDialog::showMaximumButton() const
{
	return m_bShowMaxButton;
}

void KDialog::setShowMaximumButton(bool value)
{
...
bool KDialog::showCloseButton() const
{
	return m_bShowQuitButton;
}

void KDialog::setShowCloseButton(bool value)
{
...
void KDialog::addTitleBarWidget(QWidget* pWidget, int nAlign, int nSpacing, bool bAutoFillRest)
{
...
int KDialog::winTitleBarHeight() const
{
	return m_nWinTitleBarHeight;
}

void KDialog::setWinTitleBarHeight(int value)
{
...
int KDialog::winTitleBarButtonHeight() const
{
	return m_nWinTitleButtonHeight;
}

void KDialog::setWinTitleBarButtonHeight(int value)
{
...
int KDialog::winTitleBarButtonWidth() const
{
	return m_nWinTitleButtonWidth;
}

void KDialog::setWinTitleBarButtonWidth(int value)
{
...
int KDialog::winBorderWidth() const
{
	return m_nActualBorderWidth;
}

void KDialog::setWinBorderWidth(int value)
{
...
QColor KDialog::winBorderColor() const
{
	return m_cWinBorderColor;
}

void KDialog::setWinBorderColor(QColor color)
{
	m_cWinBorderColor = color;
}

QColor KDialog::winBorderActiveColor() const
{
	return m_cWinBorderActiveColor;
}

void KDialog::setWinBorderActiveColor(QColor color)
{
	m_cWinBorderActiveColor = color;
}

int KDialog::winShadowWidth() const
{
	return m_nWinShadowWidth;
}

void KDialog::setWinShadowWidth(int value)
{
...
QColor KDialog::winShadowColor() const
{
	return m_cWinShadowColor;
}

void KDialog::setWinShadowColor(QColor color)
{
	m_cWinShadowColor = color;
}

QColor KDialog::winTitleFontColor() const
{
	return m_cWinTitleFontColor;
}

void KDialog::setWinTitleFontColor(QColor color)
{
	m_cWinTitleFontColor = color;
}

KFocusSwitchHelper<KDialog>* KDialog::iFSHelper()
{
...
/* 计算窗口边的宽度和窗口最小宽度 */
void KDialog::sizeParameters(int * nMargin, int * nMinWidth) const
{
...
void KDialog::updateContentsMargins()
{
...
void KDialog::adjustSysButtonSize()
{
